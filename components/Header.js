      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Link href="/csr-activities" className="nav-link">
              CSR Activities
            </Link>
          ...
          <Button className="eq-btn" onClick={handleClick}>
            Enquire Now
          </Button>
              ...
              >
                <div className="mb-3 mt-3">
                  ...
                  >
                    ...
                    <option
                      value="Chartered Hummingbird"
                      data-id="2/3 BHK Apartments, Rs 71.3L Onwards"
                    >
                      Chartered Hummingbird
                    </option>
                    <option
                      value="Chartered Grasshopper"
                      data-id="3/4 BHK Villas, Rs 2.51 Crores Onwards"
                    >
                      Chartered Grasshopper
                    </option>
                    <option
                      value="Chartered Veda"
                      data-id="1200 to 1500 Sq Ft Plots, Rs 21.13L Onwards"
                    >
                      Chartered Veda
                    </option>
                    <option value="Chartered Woodpecker">
