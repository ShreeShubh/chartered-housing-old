...
function contact() {
  ...
  function createPost() {
    ...
    axios
      .post(
        `${configData.SERVER_FROM}contact-form-7/v1/contact-forms/3656/feedback`,
  ...
  return (
    <>
      <Yoast
        pageTitle="Contact - Chartered Housing"
        pageDesc="Contact Chartered Housing property builder for apartments and villas Properties in Bangalore, India"
      />
      <Header />
      <Container
      ...
      <Container className="contact-bg  pb-5" fluid>
        <Container className="pt-5">
          <h2 className="text-center mb-4">
            Get In Touch With Chartered Housing
          </h2>
          <p className="fs-5">
            Whether it’s feedback or relationship building, we are always open
            to it. For queries or details on the development of our projects,
                ...
                <Row>
                  <Col sm={2} className="d-flex align-items-center">
                    <Image
                      ...
                      width={50}
                      height={40}
                      alt="Chartered Housing (P) Ltd., 27, Victoria Road, Bangalore – 560047"
                    />
                  </Col>
                  <Col>
                    <p>
                ...
                <Row className="mt-2">
                  <Col sm={2} className="d-flex align-items-center">
                    <Image
                      ...
                      width={42}
                      height={30}
                      alt="sales@charteredhousing.com"
                    />
                  </Col>
                  <Col>
                    <a
